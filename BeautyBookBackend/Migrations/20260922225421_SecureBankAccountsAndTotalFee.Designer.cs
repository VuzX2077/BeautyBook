...
namespace BeautyBookBackend.Migrations
{
    ...
    [Migration("20260922225421_SecureBankAccountsAndTotalFee")]
    partial class SecureBankAccountsAndTotalFee
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BeautyBookBackend.Models.Booking", b =>
                {
                    ...
                    b.Property<byte?>("CancellationActor")
                        .HasColumnType("smallint");

                    b.Property<DateTime?>("CancellationAppointmentAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("CancellationPolicyRule")
                        .HasMaxLength(100)
                    ...
                    b.Property<string>("FinancialPolicyVersion")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)")
                        .HasDefaultValue("V1_DEPOSIT_FEE");
            ...
            modelBuilder.Entity("BeautyBookBackend.Models.Payout", b =>
                {
                    ...
                    b.Property<string>("QrCodeUrlSnapshot")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
            ...
            modelBuilder.Entity("BeautyBookBackend.Models.Refund", b =>
                {
                    ...
                    b.Property<DateTime?>("DestinationCapturedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("DestinationQrCodeUrl")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
                    ...
                    b.Property<string>("LastProviderState")
                        .HasMaxLength(50)
                    ...
                    b.ToTable("Refunds", t =>
                        {
                            t.HasCheckConstraint("CK_Refunds_PositiveAmount", "\"Amount\" > 0");
                        });
                });
